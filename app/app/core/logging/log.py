...
class Log(dict):
    ...
    serialized, can be sent to a logging service's API for improved consumption.
...
def extract_from_tuple(args: tuple, mapping: Dict[int, str]):
    new = {}
